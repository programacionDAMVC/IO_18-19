...
public class TestStaffDAO {
	...
	private static void updatePersonByEmail() {
		...
		if (staffDAO.updatePersonByEmail(person, newEmail)) {
	...
	private static void listByGender() {
		...
		if (gender.toLowerCase().equals("male"))
			listByGender = staffDAO.getListPeopleByGender(Gender.Male);
		else
			listByGender = staffDAO.getListPeopleByGender(Gender.Female);
	...
	private static void deleteByEmail() {
		...
		if (staffDAO.removePerson(email)) {
	...
	private static void deletePerson() {
		...
		person.setFirstName(firstName);
		person.setLastName(lastName);
		if (staffDAO.removePerson(person)) {
	...
	private static void listByCountry() {
		...
		List<Person> listOfPersonByCountry = staffDAO.getListPeopleByCountry(countryName);
